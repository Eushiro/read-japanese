...
export const VIDEOS: VideoData[] = [
  ...
  // REAL YOUTUBE VIDEO - Why Introductions Are So Important in Japan
  {
    ...
    duration: 544,
    transcript: [
      { text: "やっぱり自己紹介って自分のこともそうですし、相手のこともよく知るための第1歩になるので、とても大切だと思っています。", start: 0, duration: 14 },
      { text: "こんにちは。カレンです。元気ですか?私このお仕事をしててびっくりされるんですけど、こう見えてすっごい上がり症なんですよ。", start: 14, duration: 14 },
      { text: "だからたくさんいる人の前で喋るのめちゃくちゃ苦手です。もうめすっごい緊張しちゃって、もうなんか言うこともも全部ふ吹っ飛んじゃうぐらいすごい上がり症で緊張するので初めて会う人もすごく実は緊張してドキドキしてるんですよね。", start: 28, duration: 22 },
      { text: "なのでこう私の名前を言う時とかこう自己紹介をする時多分色々間違えちゃってるんですよ。", start: 50, duration: 5 },
      { text: "初めましてカレンです。よろしくお願いします。私今20何歳なんですけどっていう年齢が間違えてたりするんですよ。", start: 55, duration: 9 },
      { text: "これ本当に昔からですごくなんかあ、頑張らなきゃな、直さなきゃなっていうのがどんどん空回りしてって、あの良くない方向に行っちゃうんですけれども、今日は日本での自己紹介についてすることはしないことというのを紹介していきたいと思います。", start: 64, duration: 25 },
      { text: "友達の紹介だと初めましてカレンです。よろしくお願いしますが、よく使うフレーズになります。ま、結構柔らかい感じの、えっと、文章で、あとは笑顔でっていうのが基本的なスタイルです。", start: 89, duration: 16 },
      { text: "初対面でもこう先輩後輩の関係っていうのはもによることが多いんですけれども、でもカジュアルな自己紹介、友達と友達の間だと割と高確率であの先輩後輩の関係っていうのはないことが多いです。", start: 105, duration: 17 },
      { text: "私はあの夫が同い年なんですよ。で、夫の友達も基本的に同い年じゃないですか。なので、その夫の友達の奥さんも私は同い年だと思ってしまって勘違いしてて、ずっとあのカジュアルな話し方をしてたんですよね。", start: 122, duration: 28 },
      { text: "で、ふと、え、年いくつって聞いたら全然私より年上だったんですよ。で、すごい謝りました。", start: 150, duration: 9 },
      { text: "その時に本当にごめんなさいって言って、私が基本的には結構年上の方にこうカジュアルな話し方をするのが好きではないので苦手好きではない。あの、できれば丁寧な敬語を使って丁寧に話をしていきたい人なので、その時すごく謝りました。", start: 159, duration: 19 },
      { text: "よく話すトピックスとしては結構やっぱ出身地とかあと趣味とか年齢も結構言いますね。カジュアルな部分だと年齢も気になることが多いので言うし聞くことが多いです。", start: 178, duration: 18 },
      { text: "最近私が初めてお話しした方で言うと子供の子遊び場に連れて行った時にいるお母さんだったんですけどもその方もお子さんと一緒に来ていて", start: 196, duration: 18 },
      { text: "で、その時にあ、初めましてみたいな感じで話をしたんですけれども、やっぱりあの子供の年齢とか一緒に遊ぶとなると子供の年齢が同じぐらいだとやっぱりお母さん同士も安心して遊ばせてあげれるので子供の年齢をやっぱ聞きますね。", start: 214, duration: 25 },
      { text: "あとは幼稚園の話幼稚園どこ行きますかとかご飯何食べますかとかお家で何食べさせてますかっていう話は結構します。", start: 239, duration: 15 },
      { text: "カジュアルな自己紹介では例えばお友達だったりとか幼稚園のママ友だったりとかそういった方には初めましてカレンです。よろしくねとかこういった軽い文章カジュアルな文章になっていて", start: 254, duration: 15 },
      { text: "逆にえっと社会人に出て初めての職場でみんなの前で自己紹介をする時は初めまして原カレンと申します。どうぞよろしくお願いします。よろしくお願いいたしますのような丁寧な文章になります。", start: 269, duration: 17 },
      { text: "名刺を交換する時にもいくつかルールがあって、これは最初からこう職場の方から教えてもらったりとか、あとは自分が社会人になるタイミングでネットで調べたりしました。", start: 286, duration: 17 },
      { text: "で、こう名刺を交換する時は基本的にこう両手で受け取る、受け取った後にすぐにポッケにはしまわないんですよ。こうお話する相手が目の前にいると机の上にこう置いておく。置いておいて話を続けるというのがマナーになります。", start: 303, duration: 21 },
      { text: "ズーム会議だと結構こう画面にここの上からでしか収まっていないことがあって結構立ったり座ったりもないですしあまりこう色々動きが見えないので見えないんですけれどもお辞儀をしたりとかこう手でジェスチャーをしたりとかはすごく大事になります。", start: 324, duration: 25 },
      { text: "日本では初めましてという言葉は本当に初めてあったその時しか使わないんですよ。なので最後の最後に初めましてでしたのような日本語は使わないです。", start: 349, duration: 15 },
      { text: "またね、じゃあねはカジュアルな場面で使うんですけれどもフォーマルな場面だとありがとうございましたやこれからもよろしくお願いしますというのが自然です。", start: 364, duration: 13 },
      { text: "こういったマナーは私は高校受験をする時に面接練習があったんですけれども、その時に先生から教わった記憶があります。あとは初めて自分が社会人になる時だったりとかに会社の上司からマナーとして教えていただいたりとか自分でネットで調べて勉強しました。", start: 377, duration: 29 },
      { text: "私は困らないように教えたいと思ってます。やっぱり特に大切だと思うのが目を見て会話をするっていうところが大切だなと思っています。", start: 406, duration: 12 },
      { text: "このマナーの勉強でもやっぱり目を見るのが恥ずかしかったりとかすごく緊張してしまう人っているのでそういう方はマナーを教えていただいてる時に目じゃなくて男性だったらここのネクタイの部分を見なさいとかそういったちょっとしたコツとかもマナーの中にはあります。", start: 418, duration: 25 },
      { text: "で、そういったコツとかも教えていただいたので、そういうのはなるべくね、社会人になる前に、そして、あの、社会人になる前じゃなくてもやっぱりこう集団生活をしていく部分では小学校幼稚園の時から大切な部分になってくると思うので教えていきたいです。", start: 443, duration: 20 },
      { text: "皆さん見ていただきありがとうございました。今日は日本での自己紹介よくすることまたはしないことというテーマでお話をしたんですけれどもいかがでしたか?", start: 463, duration: 13 },
      { text: "やっぱり自己紹介って自分のこともそうですし、相手のこともよく知るための第1歩になるのでとても大切だと思っています。", start: 476, duration: 11 },
      { text: "こう、自己紹介の印象がいいとその後の印象もよ、良くなるというか、これからもっと仲良くしていきたいなという思いにつがるので、是非ね、日本での自己紹介も勉強してみてください。", start: 487, duration: 18 },
      { text: "もう皆さんは私のこと結構知ってるんじゃないですか?やっぱり自己紹介動画とかがね、あるので、それを見て知ってくださってる方は多いと思います。", start: 505, duration: 8 },
      { text: "私も皆さんのことを知りたいので、是非コメント欄にいて教えてください。やっぱり名前とか出身地とか趣味とか色々教えていただけたら嬉しいです。", start: 513, duration: 14 },
      { text: "そして今日の動画が役に立ったりもっと日本語を勉強したいなと思った方はいいねとチャンネル登録を是非よろしくお願いします。", start: 527, duration: 14 },
      { text: "日本語はたくさん聞くことで自然と身についてきます。これからも私の日本語リラックスして楽しんでくださいね。それじゃあバイバイ。", start: 541, duration: 3 },
    ],
    questions: [
      {
      ...
      },
      {
        ...
        type: "multiple_choice",
        options: ["すぐにポケットにしまう", "片手で受け取る", "両手で受け取って机に置く", "名刺にメモを書く"],
      ...
      },
      {
        ...
        type: "multiple_choice",
        options: ["名前を間違えた", "年上だと知らずカジュアルに話した", "敬語を使いすぎた", "話題が見つからなかった"],
  ...
  // REAL YOUTUBE VIDEO - Japanese Pronunciation: Rhythm
  {
    ...
    transcript: [
      ...
      { text: "today I'd like to talk about how Japanese people conceptualize sounds", start: 17, duration: 6 },
      { text: "understanding how Japanese people recognize and conceptualize sound is very important to speak Japanese with proper Rhythm and accent", start: 23, duration: 8 },
      { text: "also it helps you to recognize sounds when you are listening to Japanese", start: 31, duration: 7 },
      { text: "so how Japanese people recognize sounds they grasp sounds using sound the unit code Mora in Japanese it is called Haku", start: 38, duration: 11 },
      { text: "Haku also means beat in music Every Beat has the same length", start: 49, duration: 8 },
      { text: "just like Mora in Japanese language so when I say", start: 57, duration: 10 },
      { text: "every mora in this taxi knowledge is supposed to be equally long even though there are some exceptions in real life conversation", start: 67, duration: 9 },
      { text: "but basically you should pronounce every mora equally long in Japanese we basically use Mora instead of syllables", start: 76, duration: 9 },
      { text: "what's the difference between mora and syllables for example hamburger in Japanese is", start: 85, duration: 13 },
      { text: "well when you say hambaga Han Han is supposed to be one syllable but if you're talking about Mora ha is two moras", start: 98, duration: 15 },
      ...
      { text: "if you don't have the concept of Mora say to Japanese people's ears it sounds a little bit weird because you don't pronounce ham long enough supposed to have two moras", start: 128, duration: 19 },
      { text: "there are three kinds of sounds you should note one is long vowel long vowel is just like you extend the vowel for one more", start: 147, duration: 14 },
      { text: "if I just say ba ba it is but if I say ba ba it has two moras it's the same when I say", start: 161, duration: 17 },
      { text: "because this vowel is extended for one more instead of saying I say Gaga", start: 178, duration: 7 },
      { text: "so it has to moras you should be careful that when you're saying long vowel you should pronounce it for two moras in length", start: 185, duration: 11 },
      { text: "it often confuses Japanese people when foreigners pronounce long vowel not long enough for example word like ojisan ojisa means Grandpa", start: 196, duration: 15 },
      { text: "G is a long vowel so you should extend another one more to pronounce it", start: 211, duration: 7 },
      { text: "but many Foreigner when they're pronouncing this word they hastily say it sounds like different word autism means Uncle it's not grandpa", start: 218, duration: 12 },
      { text: "so when you're saying this word you should extend D long enough so it sounds like Grandpa not uncle", start: 230, duration: 14 },
      { text: "the second one is sound can be pronounced as um I will cover this sound in different video", start: 244, duration: 9 },
      { text: "well for example what like has four moras foreign Learners often pronounce the syllable Khan as one more instead of two therefore it sounds too fast to Japanese ears", start: 253, duration: 16 },
      { text: "many foreigners say Kan tan like instead of saying", start: 269, duration: 17 },
      { text: "so you should remember that sound takes up the same length as any other sound", start: 286, duration: 6 },
      { text: "the last one is sound called sokun sokun is a sound of holding consonant longer something similar to glottal stuff like Saka", start: 292, duration: 11 },
      { text: "suck is instead of just saying Saka Saka well Saka has two moras but if I say has three moras", start: 303, duration: 14 },
      { text: "this topping part in the middle is called sokun so this is how Japanese people recognize sounds", start: 317, duration: 8 },
      { text: "when they hear some English words like computer they convert it into moras computer in Japanese is computer", start: 325, duration: 13 },
      { text: "so they convert it into KO um pew uh ah long vowel computer so it has six moras", start: 338, duration: 11 },
      { text: "when they hear English word like interesting interesting Japanese people convert the sound into moras", start: 349, duration: 12 },
      { text: "so interesting will be um so it has in total of eight moras", start: 361, duration: 12 },
      { text: "this is one of the reasons why Japanese pronunciation of some English words sounds funny they have different Rhythm", start: 373, duration: 8 },
      { text: "that's also why Japanese people generally have trouble learning English if your mother tongue is Japanese then you have this mora system installed in your sound recognition system", start: 381, duration: 14 },
      { text: "installing a new sound recognition system is not an easy task so for Japanese people learning English is a very difficult thing", start: 395, duration: 8 },
      { text: "the same thing can be said if your mother tongue is English because you have different sound recognition system installed in your head", start: 403, duration: 9 },
      { text: "so you would have some trouble listening to or speaking Japanese in the next video I'll prepare some exercises so you can get used to Japanese mora system", start: 412, duration: 3 },
    ],
    questions: [
      {
  ...
  // REAL YOUTUBE VIDEO - いいえ Is Lame
  {
    ...
    duration: 391,
    transcript: [
      { text: "かめ at the very first stage of your Japanese learning experience you might have learned", start: 0, duration: 6 },
      { text: "いいえ あなたは日本人ですか いいえ 私は日本人ではありません", start: 6, duration: 9 },
      { text: "in real life people rarely say いいえ to say no just too long three moras and you extend another え え", start: 15, duration: 15 },
      { text: "say in life Japanese people say いや or や instead of いいえ", start: 30, duration: 10 },
      { text: "basically if not in very formal occasion you just use いや even when you are talking in polite form", start: 40, duration: 10 },
      { text: "もしもし すいません こちらは田中さんの携帯でしょうか いや 違います", start: 50, duration: 8 },
      { text: "田中さん 普段スポーツとかやってるんですか いや 僕はやらないですね 佐藤さんは何かやってるんですか", start: 58, duration: 7 },
      { text: "いや 実は僕も何もやってないんですよ でもこれから何か始めようかなと思って", start: 65, duration: 7 },
      { text: "田中さん もしよかったら一緒にバドミントンでもやりませんか いや いいですよ 僕最近あまり時間に余裕がないんで", start: 72, duration: 11 },
      { text: "Actually you even have to pronounce え in いえ you can just say や や", start: 83, duration: 7 },
      { text: "会員カードはございますか いや ないです お作りいたしますか いや 結構です", start: 90, duration: 7 },
      { text: "クーポンはお持ちでしょうか いや ないです 駐車券はございますか いや ないです", start: 97, duration: 7 },
      { text: "紙袋はお使いでしょうか いや 大丈夫です", start: 104, duration: 3 },
      { text: "even though it is written いや but when people pronounce it people often pronounce it with one mora so they just say や や", start: 107, duration: 13 },
      { text: "because anyway when you say や や you have to say this very short え at the begin", start: 120, duration: 11 },
      { text: "first to say so when people say in everyday conversation they say や in more every time", start: 131, duration: 7 },
      { text: "会員カードはお持ちですか いや ないです いや うん people would say ないです や や just one mora", start: 138, duration: 17 },
      { text: "ね 明日きに行こう や 行かない え なんで 一緒に行こう いや 行かない 私明日家でのんびりしたいもん", start: 155, duration: 12 },
      { text: "by way や is also used to say I don't want when people use to say I don't want to use auxiliary verb", start: 167, duration: 13 },
      { text: "ね 夜うちで麻雀やるんだけどメンバー1人足りないからあんたも来て やだ 俺今日は家でゆっくり1人で映画見たいし", start: 180, duration: 12 },
      { text: "え お願い 今度ラーメンを奢ってあげるから ラーメンじゃやだ 寿司ならいいよ え 寿司はやだ 高いもん", start: 192, duration: 9 },
      { text: "when people actually say やだ most of times they say やだ やだ in mora instead of mora", start: 201, duration: 11 },
      { text: "やだ やだ has a childish vibe it has a feeling of some kids rejecting to do something of some childish reason", start: 212, duration: 10 },
      { text: "コータ もう8時だよ そろそろゲームやめなさい やだ やだじゃなくてやめなさい やだ", start: 222, duration: 12 },
      { text: "あんた いい加減にしないとテレビの電源切るよ やだ やだ ゲームやりたい", start: 234, duration: 9 },
      { text: "by the way this usage やだ やだ やだ is called 駄々をこねる", start: 243, duration: 5 },
      { text: "駄々をこねる refers to an action of rejecting to accept something that you are supposed to accept because of some selfish reason", start: 248, duration: 10 },
      { text: "南 もう帰るよ やだ まだ帰りたくない やだじゃなくてもう遅いから帰るよ やだ まだ帰りたくない まだここで遊んでたい", start: 258, duration: 12 },
      { text: "あんたもう小学生でしょ 駄々こねるんじゃない あみちゃん見てごらん", start: 270, duration: 6 },
      { text: "ほれ あみちゃんまだ6歳で小学校にも行ってないのにちゃんとお母さんの言うことを聞いて今もう帰る準備してるでしょ", start: 276, duration: 10 },
      { text: "南はもう小学生なんだからちゃんとお母さんの言うこと聞きなさい はい いい子だね", start: 286, duration: 7 },
      { text: "Let get back to the main point of this video so people use いや much use いや to say no", start: 293, duration: 7 },
      { text: "when you want to say no you can just say いや や even when you are talking in polite form", start: 300, duration: 8 },
      { text: "but in some very formal occasion when you are required to say very politely then you say いいえ to say no instead of いや", start: 308, duration: 11 },
      { text: "for example in job interview 田中さんは英語が話せますか いえ 話せません ですが中国語なら多少できます", start: 319, duration: 11 },
      { text: "以前別の旅行会社に務めた経験は終わりですか いや ありません そうですか わかりました では面接は以上です 何か質問等はございますか いや 特にありません", start: 330, duration: 15 },
      { text: "just like いや people often say いえ in one mora like イ", start: 345, duration: 7 },
      { text: "フロントでございます あのすいませんここってwi-fiありますか いえ 当ホテルwi-fiはございません", start: 352, duration: 8 },
      { text: "その代わり各部屋にランケーブルの差し込み口がございまして優先でならインターネットに接続することができます あ そうですか 分かりました", start: 360, duration: 9 },
      { text: "あ ともう1つお聞きしたいんですが ホームページで見たんですがこちらのホテルにバーがありますよね バーって今空いてるんですか", start: 369, duration: 13 },
      { text: "いえ 大変申し訳ございませんがバーは現在新型コロナウイルス蔓延防止のためにクローズしております あ そうなんですか 分かりました", start: 382, duration: 6 },
      { text: "so from now on you spare say いや to say no", start: 388, duration: 3 },
    ],
    questions: [
      {
        question: "丁寧な会話（です・ます）で「いいえ」の代わりに何を使うことが多いと言っていますか？",
        type: "multiple_choice",
      ...
      {
        question: "「やだ」という言葉を繰り返して使うと、どのような印象（ニュアンス）になりますか？",
        type: "multiple_choice",
  ...
  // REAL YOUTUBE VIDEO - My Life as a Pregnant Mom in Japan
  {
    ...
    duration: 894,
    transcript: [
      { text: "私1人目女の子で次も女の子なんですよ。いや、絶対可愛いじゃないですか。", start: 0, duration: 10 },
      { text: "こんにちは、カレンです。皆さん元気ですか?", start: 10, duration: 7 },
      { text: "私は元気にしてますよ。あの、もうすぐ子供が生まれるんですけども、結構あの、今回の妊娠はすごくあの、トラブルが少なかったかな。", start: 17, duration: 22 },
      { text: "前回に比べて、あの、やっぱ2回目っていうこともあり、結構なんか対応できるトラブルが起こってもこう心をしっかりと構えていられる、対応できることが多かったなと思ってます。", start: 39, duration: 17 },
      { text: "で、前回は本当に本当に歩くのも辛いぐらい、同じ時期今と同じ収数ぐらいの時歩くのも辛かったんですけど、今はそんなことなくて", start: 56, duration: 9 },
      { text: "やっぱ1回目と2回目でもこんなに違うんだって、えっと思いながら妊婦生活を過ごしています。", start: 65, duration: 7 },
      { text: "それでですね、今日はフリートークでは日本人のあの妊婦のお話をしていきたいと思います。", start: 72, duration: 12 },
      { text: "全ての妊婦さんがそうっていうわけではないので、なんか私だと思って、私のことだと思って聞いていただければ大変嬉しく思います。それでは始めていきますね。", start: 84, duration: 10 },
      { text: "妊娠が分かった時は本当に予想外で、ま、予想外っていう言い方あってるとかなんかびっくりしました。", start: 94, duration: 11 },
      { text: "そう、まだ上の娘も小さかったですし、まだ一切なってなかったんですよね。何ヶ月かな?7ヶ月とか8ヶ月ぐらいだったと思うんですけども。", start: 105, duration: 16 },
      { text: "でも本当にびっくりしました。で、まだその娘も小さいですし、受入もしてましたし", start: 121, duration: 11 },
      { text: "で、あの妊娠するとあの受入をやめなきゃいけないんですよね。っていうのがその子宮がこう収縮、受入することによって子宮が収縮されて", start: 132, duration: 12 },
      { text: "えっと赤ちゃんが流れてしまう流算してしまう可能性っていうのが上がるので受入もやめなきゃいけない。嬉しい反面。驚きと嬉しいと複雑がもう一気にこう来ましたね。", start: 144, duration: 16 },
      { text: "赤ちゃん、ま、ずっと動いてるんですけども大きくなるにつれて私まで動いてるのが伝わってくるんですよね。", start: 160, duration: 10 },
      { text: "っていうのが分かった時にもうすごいあのお腹をこうねなあかんて言っちゃったこうお腹を撫でたりとかあと最近で言うともう結構もうバコバゴ蹴ってくるんで", start: 170, duration: 11 },
      { text: "あの蹴られたら私もこう押し返すて言うんですかね。っていう感じでコミュニケーションは取っています。", start: 181, duration: 6 },
      { text: "妊婦さんの時ってNGな食材とか結構たくさんあるんですよね。食べられないもんとかたくさんあるので、そういったものは基本的に食べないことと", start: 187, duration: 10 },
      { text: "あと、えっと、望をしない。あとはもう、えっと、1人目の時はすごくあの、歩けないぐらいお尻が痛かったので、あまり運動できなかったんですけれども", start: 197, duration: 14 },
      { text: "2人目になるとお尻全然痛くないんですよ。股関節は痛いんですけど、関節は痛いんですけども、お尻全然痛くないので全然あの歩けるので", start: 211, duration: 9 },
      { text: "あと娘のね子育てもありますしもう働いてたのも前回の妊娠の時より2倍の日数時間働いてるので", start: 220, duration: 11 },
      { text: "そういった面ではやっぱ体を動かしているっていうところはすごくね気をつけてるってかましなきゃいけなくて", start: 231, duration: 10 },
      { text: "そういう生活で体を動かしてるのもありますけどもやっぱ犬の散歩に行くとか娘と一緒にお出かけするとかそういった面では本当に強制的に体を動かしているっていう感じになります。", start: 241, duration: 14 },
      { text: "3級育級級っていうのがありまして3級生む時ですね予定日から6周前まで遡ってえっと3級が取ります取れます。", start: 255, duration: 14 },
      { text: "で、運んで8周まで3級が取れます。で、そこからは育児休暇という育級っていう期間になるんですけども", start: 269, duration: 9 },
      { text: "基本的にはそのお子さんが1歳になるまで満一になるまでえっと育児休暇が取れる会社が多いというイメージですね。", start: 278, duration: 9 },
      { text: "あとはやっぱりあの公務員と呼ばれる仕事の方とかは3歳になるまでえっと育級を取られる方もいらっしゃいます。", start: 287, duration: 12 },
      { text: "電車に乗った時にすごい速さで変わってくれたのが若い女の子。若い女の子と息のか電車。", start: 299, duration: 9 },
      { text: "若い女の子が譲ってくれて。これもすごい嬉しかったですね。あとおじさん私よりか確実に5年齢が上のでもまだ言っても50代とか50代うんくらいかなっていう", start: 308, duration: 19 },
      { text: "おじさんが席を譲ってくださってすごい嬉しかったですね。", start: 327, duration: 11 },
      { text: "なんかやっぱりな、何て言うんだろう?譲らないっていう、譲りたくない、気づかない人ってたくさんいらっしゃいますし、", start: 338, duration: 12 },
      { text: "そういうニュースとかね、SNSでそういうつぶやきとかを見た時に、あの、悲しいなって思ったりね、するんですけどね。", start: 350, duration: 9 },
      { text: "やっぱそういうのを見てるからこそ譲ってもらえた時ってやっぱ当たり前じゃないんだなって思いますし嬉しい気持ちになりましたね。", start: 359, duration: 11 },
      { text: "私それこそ今日この後あのピラティスやってみようと思ってピラティス行くんですよ。はい。初めて初めて行きます。めちゃくちゃ楽しみです。", start: 370, duration: 16 },
      { text: "ピラティスだったりとかあとヨガされる方とかもいますね。私は基本的にあの足がすごくむのでマッサージと", start: 386, duration: 8 },
      { text: "あと股関節を柔らかくするストレッチをしてるんですけどもうんあとはまひたすら歩く散歩するとかそういった感じで色々あります。", start: 394, duration: 13 },
      { text: "私は今日ピラティスに行ってきます。日本の伝統的な習慣として犬の日というのがあるんですよね。", start: 407, duration: 7 },
      { text: "あの、安算祈願の日なんですけど、安算祈願をするために神社にお参りをするんですよね。", start: 414, duration: 9 },
      { text: "それが、えっと、妊娠5ヶ月に入った最初の犬の日に行きます。", start: 423, duration: 5 },
      { text: "まだちょっとお腹の膨らみが分かるかな?多分わかんないなぐらいの大きさの時に神社に行って、えっと、安算祈願をしてもらって", start: 428, duration: 10 },
      { text: "なんかお米とか演技のいいものとかお札とかをもらっていただいて帰るんですけれども", start: 438, duration: 5 },
      { text: "なんで犬の日かって言うと犬ってあの子供を多く生むらしいんですよね。多く生む2匹以上で比較的に安ざなんですよ。", start: 443, duration: 16 },
      { text: "みたいなんですよね。だからその犬が安ざなことにあかって安ざを祈願してるっていうのを調べた時に", start: 459, duration: 9 },
      { text: "私も1人目の時調べた時にへえてなんで犬にって言うんだろうと思って調べた時にあそういうことかと思って納得したんですけれども", start: 468, duration: 12 },
      { text: "犬の日には皆さんお宮に参って安算を祈願します。", start: 480, duration: 6 },
      { text: "妊婦向けと言いますか、それぞれやっぱ自治体によっていろんなサービスが受けられるんですよね。", start: 486, duration: 5 },
      { text: "お母さん調子どうですかって電話かかってきたり、そのスクスクサポートっていう私が住んでるところではスクスクサポートって呼ばれてるんですけども", start: 491, duration: 14 },
      { text: "ま、そのスクスクサポートほにゃらという呼ばれているところに行くと、ま、そういうあのお話相談とか色々お話を聞いてくださって最後に子品をいただけるみたいな感じで", start: 505, duration: 13 },
      { text: "そういうサービスはあります。役場とか市役所とかで結構そういう子供に行くと相談に乗ってくださる方は常にいらっしゃるので", start: 518, duration: 10 },
      { text: "そういった面ではあの利用しできる環境があるっていうのは心強いですね。", start: 528, duration: 6 },
    ],
    questions: [
      {
      ...
      },
      {
        ...
        type: "multiple_choice",
        options: ["犬は妊娠期間が短い", "犬は1匹以上の子どもを安全に生む", "犬は日本の伝統的な動物である", "犬は神社の守り神である"],
      ...
      },
      {
        ...
        type: "multiple_choice",
        options: ["仕事をしていないから", "経験があり心の準備ができているから", "家族のサポートが多いから", "若いから"],
