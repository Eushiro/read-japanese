      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-surface rounded-lg border border-border p-4 text-center">
            ...
            <p className="text-sm text-foreground-muted">Correct</p>
          </div>
          <div className="bg-surface rounded-lg border border-border p-4 text-center">
            ...
            <p className="text-sm text-foreground-muted">Incorrect</p>
          </div>
          <div className="bg-surface rounded-lg border border-border p-4 text-center">
        ...
        {attempt.sectionScores && attempt.sectionScores.length > 0 && (
          <div className="bg-surface rounded-xl border border-border p-6 mb-8">
            <h2 className="font-semibold mb-4">Section Breakdown</h2>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-foreground-muted">
                        {q.earnedPoints ?? 0} / {q.questionData?.points} pts
                      </span>
                      {isExpanded ? (
